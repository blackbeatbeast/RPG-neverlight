...
commands, items, affixes, Memory Cards, recipes, codex entries, quests, dispatches, drop tables,
...
The CLI builds this package, validates `content/first-region/bundle.json`, and
...
the checksum. The small `content/examples/bundle.json` remains a schema regression
fixture for package tests.
